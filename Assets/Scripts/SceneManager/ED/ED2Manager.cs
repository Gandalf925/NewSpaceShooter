...
public class ED2Manager : MonoBehaviour
{
    ...
    IEnumerator ED1()
    {
        ...
        greenEgg.transform.DOScale(50f, 2f);
        ...
        player.transform.DOShakeScale(2f, 10f, 100, 90f, false);
        player.transform.DOMove(playerStopPos.position, 6f);
        player.transform.DOScale(200f, 2f);

        yield return new WaitForSecondsRealtime(2f);
        player.transform.DOShakeScale(2f, 20f, 100, 90f, false);

        yield return new WaitForSecondsRealtime(2f);
        player.transform.DOShakeScale(2f, 30f, 100, 90f, false);
        yield return new WaitForSecondsRealtime(2f);
        ...
        player.transform.localScale = new Vector3(100f, 100f, 1f);
        ...
        player.transform.DOScale(2000f, 1f);
